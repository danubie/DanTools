#
# Modulmanifest f�r das Modul "PSGet_IsaWebSqlToolbox"
#
# Generiert von: Wolfgang Wagner
#
# Generiert am: 21.09.2019
#
...
GUID = 'b64e9f1c-f4ec-477a-9b6e-e84096f5eae8'
...
Copyright = '(c) 2018-2019 Wolfgang Wagner. Alle Rechte vorbehalten.'

# Beschreibung der von diesem Modul bereitgestellten Funktionen
Description = 'Tools fuer uns und euch'
...
FunctionsToExport = 'Get-IsaAdminCredential'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/danubie/DanTools/blob/master/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/danubie/DanTools'
